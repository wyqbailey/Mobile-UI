...
(function($){
	...
	var Tour = {
		...
		showControls: function(){
			...
			tourcontrols += '<span class="tour-button" id="activatetour">开始向导</span>';
			tourcontrols += '<span id="latertour" class="tour-button latertour">不用了，谢谢</span>';
			if(!$.tour.options.autoplay){
				tourcontrols += '<div class="nav"><span class="tour-button" id="prevstep" style="display:none;">< 上一步</span>';
				tourcontrols += '<span class="tour-button" id="nextstep" style="display:none;">下一步 ></span>';
                tourcontrols += '<span class="tour-button" id="endtour" style="display:none;">完成</span></div>';
			}
			...
			tourcontrols += '<span title="关闭" class="close" id="canceltour"></span>';
			tourcontrols += '</div>';
			
			$('body').prepend(tourcontrols);
			$('#tourcontrols').animate({'left':'20px'},500);
		...
		showTooltip: function(){
			...
			switch(tip_position){
                ...
                case 'C'	:
					...
					//tooltip.find('span.tooltip_arrow').removeClass("tooltip_arrow");
					break;
			}
